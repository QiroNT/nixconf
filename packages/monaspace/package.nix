# https://github.com/NixOS/nixpkgs/pull/437011 with nerdfont
{
  lib,
  stdenvNoCC,
  fetchFromGitHub,
...
stdenvNoCC.mkDerivation (finalAttrs: {
  ...
  installPhase = ''
    ...
    find "NerdFonts" -type f -name '*.otf' \
    ...
    find "NerdFonts Web Fonts" -type f -name '*.woff2' \
      -exec install -Dm644 {} -t $woff/share/fonts/woff2 \;
    find "Static Web Fonts" -type f -name '*.woff2' \
      -exec install -Dm644 {} -t $woff/share/fonts/woff2 \;
    find "Variable Web Fonts" -type f -name '*.woff2' \
      -exec install -Dm644 {} -t $woff/share/fonts/woff2 \;
